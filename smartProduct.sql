...
DROP TABLE smartProduct;
CREATE TABLE smartProduct
( 
...
INSERT INTO smartProduct VALUES
...
-- FIRST_VALUE 
-- Write query to display the most expensive smartProduct under each category (corresponding to each record)
select *,
...
-- LAST_VALUE 
-- Write query to display the least expensive smartProduct under each category (corresponding to each record)
select *,
...
-- NTH_VALUE 
-- Write query to display the Second most expensive smartProduct under each category.
select *,
first_value(product_name) over w as most_exp_product,
last_value(product_name) over w as least_exp_product,
